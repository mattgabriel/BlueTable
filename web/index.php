...
define('WEB_URL','http://xxx.xxx.xxx.xxx'.WEB_FOLDER); //http://www.xxx.com without trailing slash
...
function getdbh() {
  if (!isset($GLOBALS['dbh']))
    try {
      ...
      $GLOBALS['dbh'] = new PDO('mysql:host=localhost;dbname=BlueTable', 'root', 'Blu3Tabl0');
